...
| **Tests** | 405 passing, no credentials required, hermetic. Several exist because the bug happened: the approval contract, simulated/real isolation, the duplicate notification. |
