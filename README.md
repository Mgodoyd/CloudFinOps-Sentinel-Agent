...
Run the tests with `pytest` — **397 pass, 2 skip** (the two need the
...
399 tests — 397 pass and 2 skip where the OpenTelemetry exporter is
...
tests/                    399 tests, no credentials needed
```
