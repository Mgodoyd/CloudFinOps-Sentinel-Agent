...
Run the tests with `pytest` — **403 pass, 2 skip** (the two need the
...
405 tests — 403 pass and 2 skip where the OpenTelemetry exporter is
...
tests/                    405 tests, no credentials needed
```
