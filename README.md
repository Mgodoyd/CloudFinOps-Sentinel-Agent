...
Run the tests with `pytest` — **402 pass, 2 skip** (the two need the
...
404 tests — 402 pass and 2 skip where the OpenTelemetry exporter is
...
tests/                    404 tests, no credentials needed
```
