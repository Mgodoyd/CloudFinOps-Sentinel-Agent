...
CATALOG: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "ev.billed_cost": "Actually billed (last {days}d, normalised)",
        "ev.billed_partial": "Actually billed ({days}d of data only — partial)",
        ...
        "src.billing_export": "Cloud Billing export",
    ...
    "es": {
        ...
        "ev.billed_cost": "Facturado real (últimos {days}d, normalizado)",
        "ev.billed_partial": "Facturado real (solo {days}d de datos — parcial)",
        ...
        "src.billing_export": "Export de Cloud Billing",
